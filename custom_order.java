...
public class custom_order {
   ...
   /* System.out.println("Welcome to java' cake & Cupcake Shop!");
    ...
    System.out.println("-----------------------------------");
    System.out.println("Frostings(vanilla,chocolat,strawberry,coco)");
  ...
  itemOrder = keyboard.nextLine();
   ...
   System.out.println("vanilla, Chocolat, Strawberry or cocoa");
   frostingType =  keyboard.nextLine();
    ...
    System.out.println("ItemOrdered: "+itemOrder);
